# WebBotMTZA - Microsoft Teams App
...
3. Create a new *Web App* with Windows App Service Plan and give it the name of your tab, the same you used when asked for URL in the Yeoman generator. In your case https://webbotmtza.azurewebsites.net.
...
13. Wait until the deployment is completed and navigate to https://webbotmtza.azurewebsites.net/privacy.html to test that the web application is running
14. Done

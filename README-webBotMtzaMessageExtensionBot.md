# WebBotMTZA Message Extension Bot - `webBotMtzaMessageExtensionBot`
...
3. Give the bot a handle (ex: `webBotMtzaMessageExtensionBot`), choose your subscription and resource group
4. For the messaging endpoint, use this: `https://webbotmtza.azurewebsites.net/api/messages`
